...
public class JobCompleteHelper {
    ...
    public void start() {
        ...
        callbackThreadPool = new ThreadPoolExecutor(
            ...
            r -> new Thread(r, "sd-job, admin JobLosedMonitorHelper-callbackThreadPool-" + r.hashCode()),
            (r, executor) -> {
                r.run();
        ...
        monitorThread = new Thread(() -> {
            ...
            while (!toStop) {
                try {
                    ...
                    List<Long> losedJobIds = SdJobAdminConfig.getAdminConfig().getSdJobLogMapper()
