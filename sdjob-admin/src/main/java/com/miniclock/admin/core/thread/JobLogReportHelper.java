                ...
                while (!toStop) {
                    try {
                        ...
                        for (int i = 0; i < 3; i++) {
                            ...
                            Map<String, Object> triggerCountMap = SdJobAdminConfig.getAdminConfig().getSdJobLogMapper().findLogReport(todayFrom, todayTo);
                    ...
                    if (SdJobAdminConfig.getAdminConfig().getLogretentiondays()>0
                        ...
                        do {
                            ...
                            logIds = SdJobAdminConfig.getAdminConfig().getSdJobLogMapper().findClearLogIds(0, 0, clearBeforeTime, 0, 1000);
                            //判断集合是否为空
